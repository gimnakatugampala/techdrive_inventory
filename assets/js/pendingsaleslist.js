$(document).ready(function () {
    ...
    function populateTable(data) {
      var tableBody = $("table.datanew.pendingsaleslist #pendingsaleslistbody");
    ...
    $.getJSON("../pages/pendingsales.php", function (data) {
      populateTable(data);
    });
  
    $("table.pendingsaleslist").on("click", ".btnedit", function () {
    ...
    $("table.pendingsaleslist").on("click", ".btn-delete", function () {
    ...
    $("table.pendingsaleslist").on("click", ".cancel-sale", function () {
