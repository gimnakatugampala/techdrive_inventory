$(document).ready(function () {
    ...
    function populateTable(data) {
      var tableBody = $("table.datanew.comepletedsaleslist #completedsaleslistbody");
    ...
    $.getJSON("../pages/completedsales.php", function (data) {
      populateTable(data);
    });
  
    $("table.comepletedsaleslist").on("click", ".btnedit", function () {
    ...
    $("table.comepletedsaleslist").on("click", ".btn-delete", function () {
